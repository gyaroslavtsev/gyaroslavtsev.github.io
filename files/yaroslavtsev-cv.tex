...
\begin{innerlist}
\item Research in approximation and online algorithms for scheduling (with N. Devanur, K. Makarychev and D. Panigrahi, in submission to ICALP'14).
\item Research in approximation algorithms for correlation clustering (with K. Makarychev, T. Schramm).
\end{innerlist}
...
\section{Submitted}
\begin{lonelist}
\item \textbf{Online Machine Minimization and Related Problems}, with Nikhil Devanur, Konstantin Makarychev and Debmalya Panigrahi.

In submission to ICALP 2014 (41st International Colloquium on Automata, Languages, and Programming), Track A.
...
In submission to CRYPTO 2014 (34rd International Cryptology Conference). 
\if\online0 
...
In submission to KDD 2014 (20th ACM SIGKDD Conference on Knowledge Discovery and Data Mining). 
\if\online0 
