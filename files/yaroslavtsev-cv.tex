...
Authors listed in alphabetical order:
\begin{outerlist}
\item ``Going for Speed: Sublinear Algorithms for Dense r-CSPs''.

Tech report: \href{http://arxiv.org/abs/1407.7887}{ArXiv:1407.7887}

\item ``Online Algorithms for Machine Minimization'', with N. Devanur, K. Makarychev and D. Panigrahi.
...
Program committees:
\begin{innerlist}
	\item 28th Annual ACM-SIAM Symposium on Discrete Algorithms (SODA'17).
