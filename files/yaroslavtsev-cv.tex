...
\section{Achievements and awards} \begin{innerlist}
\item \textbf{Warren Center Postdoctoral Fellowship} at University of Pennsylvania, 2014 ---.
\item \textbf{Institute Postdoctoral Fellowship} at Brown University, ICERM, 2013 --- 2014.
...
\section{Teaching}
``\textbf{Algorithms for Big Data}'' (Instructor)
\begin{innerlist}
  \item University of Pennsylvania, CIS 700, Fall 2015.
\end{innerlist}

``\textbf{Computational Learning Theory}'' (Co-Instructor)
\begin{innerlist}
	\item University of Pennsylvania, CIS 625, Spring 2015 (co-teaching with Michael Kearns).
\end{innerlist}

``\textbf{Sublinear Algorithms for Big Data}'' (Instructor)
\begin{innerlist}
...
\section{Graduate students mentored}
\begin{innerlist}
