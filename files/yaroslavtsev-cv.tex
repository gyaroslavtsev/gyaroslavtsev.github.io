...
\medskip
Postdoctoral Research Fellow in Mathematics and Computer Science.
%\end{outerlist}
%\section{Education}
...
\begin{innerlist}
\item Research in approximation algorithms for scheduling and clustering problems (with N. Devanur, K. Makarychev and D. Panigrahi).
\end{innerlist}
...
\begin{innerlist}
\item Parallel algorithms for large-scale geometric problems (with A. Andoni, A. Nikolov and K. Onak, in submission to STOC'14).
\end{innerlist}
...
\item A communication protocol and lower bounds for computing the intersection (join) of distributed databases (with D. Woodruff, in submission to CCC'14, U.S. patent pending).
\end{innerlist}
...
\item Approximation algorithms for finding overlapping clusters using qualitative informaion (with H. Karloff and A. Wirth, in submission).
\end{innerlist}
...
%\blankline
%
%\textbf{FBReader project} (\href{http://www.fbreader.org/fbreaderj}{www.fbreader.org/fbreaderj}).
%
%Java developer, October 2007 --- April 2008.
%
%\blankline
...
\item Best Graduate Research Assistant Award at Computer Science and Engineering Department (2012).
\item \href{http://grigory.us/files/TCO10-Program.pdf}{TopCoder Open Algorithm Competition onsite finalist (Top 24 worldwide, handle ``griffon'')}, 2010.
\item College of Engineering Fellowship by the Pennsylvania State University, Fall 2010 --- Spring 2013.
\item University Graduate Fellowship by the Pennsylvania State University, Fall 2010 --- Spring 2011.
\item Yandex personal research grant, 2009-2010.
...
In submission to the 46th ACM Symposium on the Theory of Computing, (STOC 2014). 
\if\online0 
...
\item \textbf{Testing with Respect to $L_p$ Distances}, with Piotr Berman and Sofya Raskhodnikova.
...
\item \textbf{The Communication Complexity of Certifying Equality and Finding the Intersection}, with Joshua Brody, Amit Chakrabarti, Ranganath Kondapally and David Woodruff.

In submission to the 29th IEEE Conference on Computational Complexity, (CCC 2014). 
\if\online0 
...
\item \textbf{Correlation Clustering with Overlaps}, with Howard Karloff and Anthony Wirth.
...
29th IEEE International Conference on Data Engineering (ICDE 2013). Available as \href{http://arxiv.org/pdf/1207.6096.pdf}{ArXiv:1207.6096}.
...
37th International Conference on Very Large Data Bases (VLDB 2011), Research track.
...
38th International Colloquium on Automata, Languages and Programming (ICALP 2011), Track A. 
...
12th International Conference on Theory and Applications of Satisfiability Testing (SAT 2009), LNCS 5584, pp. 32-44, 2009.
...
\section{Service}
Organized \href{http://grigory.us/theory-seminar-brown-fall13.html}{Theory Seminar} at Brown CS Department (2013 -- 2014).
...
\item Conferences: FOCS'13, MFCS'13, ICALP'13, SODA'13, APPROX'12, FOCS'12, COCOA'12, SWAT'12, SODA'12, VLDB'12, WADS'11, MFCS'10, SAT'10.
\end{innerlist}
...
Organized a theory reading group at Penn State:
\begin{innerlist}
